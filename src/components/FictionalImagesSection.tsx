...
interface FictionalImagesSectionProps {
  images: CommunicationItem[];
  settings: UserSettings;
  onAddCustom: () => void;
}

export function FictionalImagesSection({ images, settings, onAddCustom }: FictionalImagesSectionProps) {
    ...
    <div className="h-full flex flex-col">
      ...
      <div className="p-4" style={{ backgroundColor: '#0A2351' }}>
        <div className="flex items-center justify-between">
          <h2 className="text-2xl" style={{ color: '#FFFFFF' }}>Imagens Ilustradas</h2>
          <button
            onClick={onAddCustom}
