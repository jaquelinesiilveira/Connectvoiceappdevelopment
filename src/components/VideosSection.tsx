...
interface VideosSectionProps {
  videos: CommunicationItem[];
  settings: UserSettings;
  onAddCustom: () => void;
}

export function VideosSection({ videos, settings, onAddCustom }: VideosSectionProps) {
    ...
    <div className="h-full flex flex-col">
      ...
      <div className="p-4" style={{ backgroundColor: '#0A2351' }}>
        <div className="flex items-center justify-between">
          <h2 className="text-2xl" style={{ color: '#FFFFFF' }}>Vídeos</h2>
          <button
            onClick={onAddCustom}
